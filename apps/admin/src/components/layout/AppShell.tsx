...
const FALLBACK_USER = { name: 'Admin', email: 'admin@qrnlab.org', role: 'admin' };
      ...
      <header class="glass sticky top-0 z-40 border-b border-border">
        <div class="flex h-14 items-center gap-3 px-4 sm:px-6">
          ...
          <a href="/" class="flex items-center gap-2.5" onClick={closeMobile}>
            ...
            <span class="hidden rounded-[var(--radius)] border border-border px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-[0.14em] text-fg-faint sm:inline">
              Admin
            </span>
          </a>
          ...
          <div class="ml-auto flex items-center gap-2">
            ...
            <UserMenu user={props.user ?? FALLBACK_USER} onLogout={props.onLogout} />
          </div>
        </div>
      </header>
