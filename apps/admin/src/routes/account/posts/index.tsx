    ...
    <RequireAuth>
      <div class="flex flex-col gap-6">
        <header class="flex flex-wrap items-end justify-between gap-4">
          ...
          <Button onClick={() => navigate('/account/posts/new')}>New post</Button>
        </header>
        ...
        <Show when={data() && posts().length === 0}>
          <EmptyState
            ...
            action={<Button onClick={() => navigate('/account/posts/new')}>New post</Button>}
            lines
          />
        </Show>
                ...
                {(post) => (
                  <TableRow>
                    <TableCell class="font-medium text-fg">
                      <a href={`/account/posts/${post.id}`} class="transition-colors hover:text-amber">
                        {post.title}
                      </a>
                    </TableCell>
                    <TableCell>
                    ...
                    <TableCell>
                      <div class="flex items-center justify-end gap-1.5">
                        <Button as="a" href={`/account/posts/${post.id}`} variant="outline" size="xs">
                          Edit
                        </Button>
